...
## Sprint 2 — Gestión de Trabajos (M5)
...
**Definición de hecho:**
- [ ] Asignación y desasignación funcionales.
- [ ] Respuesta incluye lista actualizada.
- [ ] Tests pasan.
...
**Definición de hecho:**
- [ ] Migración aplicada si procede.
- [ ] GET devuelve comentarios ordenados por fecha.
- [ ] POST crea comentario con autor y timestamp.
...
- [ ] Badges de estado con color semántico (pendiente=gris, en_curso=azul, bloqueado=ámbar, finalizado=verde, cancelado=rojo).
...
- [ ] Limpiar filtros restaura listado completo.
...
**Definición de hecho:**
- [ ] Selector de cliente funcional con búsqueda.
- [ ] Alta y edición sin recargar la página.
...
**Definición de hecho:**
- [ ] Cambio de estado sin abrir formulario completo.
- [ ] Lista de asignados actualizada en tiempo real.
...
**Definición de hecho:**
- [ ] Comentarios cargados al abrir el detalle.
- [ ] Nuevo comentario aparece inmediatamente tras guardar.
- [ ] Autor y fecha visibles en cada mensaje.
